...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL37C0R756) ).
  KONV = ETL37C0R756[ 1 ].
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL73C0R9308) ).
  TYPES: BEGIN OF TYL73C0R5808,
    KRELI TYPE KONV-KRELI,
    KDATU TYPE KONV-KDATU,
  END OF TYL73C0R5808.
  DATA LML73C0R6793 TYPE TYL73C0R5808.
  LML73C0R6793-KRELI = ETL73C0R9308[ 1 ]-KRELI.
  LML73C0R6793-KDATU = ETL73C0R9308[ 1 ]-KDATU.
  MOVE-CORRESPONDING LML73C0R6793 TO KONV.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
 ...
 ( fieldname = 'KDATU' value = L_DATUM )
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL86C0R7823) ).
  TYPES: BEGIN OF TYL86C0R5832,
    KRELI TYPE KONV-KRELI,
  END OF TYL86C0R5832.
  DATA LML86C0R7215 TYPE TYL86C0R5832.
  LML86C0R7215-KRELI = ETL86C0R7823[ 1 ]-KRELI.
  MOVE-CORRESPONDING LML86C0R7215 TO KONV.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
* End of Quick Fix
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL300C0R4051) ).
  KONV = ETL300C0R4051[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
 ...
 ( fieldname = 'KPOSN' value = 3 )
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL313C0R6534) ).
  KONV = ETL313C0R6534[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL326C0R5116) ).
  LS_KONV = ETL326C0R5116[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL352C0R8471) ).
  TYPES: BEGIN OF TYL352C0R1741,
    KSCHL TYPE KONV-KSCHL,
    KRECH TYPE KONV-KRECH,
  END OF TYL352C0R1741.
  DATA LML352C0R6293 TYPE TYL352C0R1741.
  LML352C0R6293-KSCHL = ETL352C0R8471[ 1 ]-KSCHL.
  LML352C0R6293-KRECH = ETL352C0R8471[ 1 ]-KRECH.
  LS_KONV = LML352C0R6293.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL482C0R1255) ).
  LS_KONV = ETL482C0R1255[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL495C0R8039) ).
  LS_KONV_CUST = ETL495C0R8039[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL508C0R1825) ).
  LS_KONV = ETL508C0R1825[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL521C0R8096) ).
  TYPES: BEGIN OF TYL521C0R1292,
    KRECH TYPE KONV-KRECH,
  END OF TYL521C0R1292.
  DATA LML521C0R7120 TYPE TYL521C0R1292.
  LML521C0R7120-KRECH = ETL521C0R8096[ 1 ]-KRECH.
  MOVE-CORRESPONDING LML521C0R7120 TO LS_KONV.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL534C0R9442) ).
  TYPES: BEGIN OF TYL534C0R9699,
    KRECH TYPE KONV-KRECH,
  END OF TYL534C0R9699.
  DATA LML534C0R3936 TYPE TYL534C0R9699.
  LML534C0R3936-KRECH = ETL534C0R9442[ 1 ]-KRECH.
  MOVE-CORRESPONDING LML534C0R3936 TO LS_KONV_CUST.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL547C0R5112) ).
  LS_KONV = ETL547C0R5112[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL560C0R4789) ).
  MOVE-CORRESPONDING ETL560C0R4789[ 1 ] TO LS_KONV_CUST.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL573C0R6877) ).
  LS_KONV-KRECH = ETL573C0R6877[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL586C0R8074) ).
  LV_KONV_KRECH = ETL586C0R8074[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
