...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL37C0R833) ).
  KONV = ETL37C0R833[ 1 ].
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL73C0R162) ).
  TYPES: BEGIN OF TYL73C0R7503,
    KRELI TYPE KONV-KRELI,
    KDATU TYPE KONV-KDATU,
  END OF TYL73C0R7503.
  DATA LML73C0R3867 TYPE TYL73C0R7503.
  LML73C0R3867-KRELI = ETL73C0R162[ 1 ]-KRELI.
  LML73C0R3867-KDATU = ETL73C0R162[ 1 ]-KDATU.
  MOVE-CORRESPONDING LML73C0R3867 TO KONV.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
 ...
 ( fieldname = 'KDATU' value = L_DATUM )
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL86C0R3493) ).
  TYPES: BEGIN OF TYL86C0R6082,
    KRELI TYPE KONV-KRELI,
  END OF TYL86C0R6082.
  DATA LML86C0R7781 TYPE TYL86C0R6082.
  LML86C0R7781-KRELI = ETL86C0R3493[ 1 ]-KRELI.
  MOVE-CORRESPONDING LML86C0R7781 TO KONV.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
* End of Quick Fix
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL300C0R7992) ).
  KONV = ETL300C0R7992[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
 ...
 ( fieldname = 'KPOSN' value = 3 )
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL313C0R9297) ).
  KONV = ETL313C0R9297[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL326C0R6507) ).
  LS_KONV = ETL326C0R6507[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL352C0R7920) ).
  TYPES: BEGIN OF TYL352C0R5721,
    KSCHL TYPE KONV-KSCHL,
    KRECH TYPE KONV-KRECH,
  END OF TYL352C0R5721.
  DATA LML352C0R1227 TYPE TYL352C0R5721.
  LML352C0R1227-KSCHL = ETL352C0R7920[ 1 ]-KSCHL.
  LML352C0R1227-KRECH = ETL352C0R7920[ 1 ]-KRECH.
  LS_KONV = LML352C0R1227.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL482C0R5029) ).
  LS_KONV = ETL482C0R5029[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL495C0R8464) ).
  LS_KONV_CUST = ETL495C0R8464[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL508C0R477) ).
  LS_KONV = ETL508C0R477[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL521C0R1201) ).
  TYPES: BEGIN OF TYL521C0R1994,
    KRECH TYPE KONV-KRECH,
  END OF TYL521C0R1994.
  DATA LML521C0R2000 TYPE TYL521C0R1994.
  LML521C0R2000-KRECH = ETL521C0R1201[ 1 ]-KRECH.
  MOVE-CORRESPONDING LML521C0R2000 TO LS_KONV.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL534C0R6129) ).
  TYPES: BEGIN OF TYL534C0R4025,
    KRECH TYPE KONV-KRECH,
  END OF TYL534C0R4025.
  DATA LML534C0R9449 TYPE TYL534C0R4025.
  LML534C0R9449-KRECH = ETL534C0R6129[ 1 ]-KRECH.
  MOVE-CORRESPONDING LML534C0R9449 TO LS_KONV_CUST.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL547C0R9914) ).
  LS_KONV = ETL547C0R9914[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL560C0R7584) ).
  MOVE-CORRESPONDING ETL560C0R7584[ 1 ] TO LS_KONV_CUST.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL573C0R285) ).
  LS_KONV-KRECH = ETL573C0R285[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL586C0R2475) ).
  LV_KONV_KRECH = ETL586C0R2475[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
