*&---------------------------------------------------------------------*
*& Report z_s4h_bseg_data_check_00
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT z_ccm_bseg_data_check_00.
...
DATA RLDNR_L27C0R8472 TYPE RLDNR.
CALL FUNCTION 'FAGL_GET_LEADING_LEDGER'
  IMPORTING E_RLDNR = RLDNR_L27C0R8472
  EXCEPTIONS NOT_FOUND     = 1
             MORE_THAN_ONE = 2.
IF SY-SUBRC = 0.
CALL FUNCTION 'FAGL_GET_GL_DOCUMENT'
  EXPORTING
    I_RLDNR = RLDNR_L27C0R8472
    I_BUKRS = I_BUKRS
    I_BELNR = I_BELNR
    I_GJAHR = FISCYEAR
  IMPORTING
