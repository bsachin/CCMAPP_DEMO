...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL37C0R7732) ).
  KONV = ETL37C0R7732[ 1 ].
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL73C0R411) ).
  TYPES: BEGIN OF TYL73C0R1882,
    KRELI TYPE KONV-KRELI,
    KDATU TYPE KONV-KDATU,
  END OF TYL73C0R1882.
  DATA LML73C0R6805 TYPE TYL73C0R1882.
  LML73C0R6805-KRELI = ETL73C0R411[ 1 ]-KRELI.
  LML73C0R6805-KDATU = ETL73C0R411[ 1 ]-KDATU.
  MOVE-CORRESPONDING LML73C0R6805 TO KONV.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
 ...
 ( fieldname = 'KDATU' value = L_DATUM )
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL86C0R3913) ).
  TYPES: BEGIN OF TYL86C0R5169,
    KRELI TYPE KONV-KRELI,
  END OF TYL86C0R5169.
  DATA LML86C0R8461 TYPE TYL86C0R5169.
  LML86C0R8461-KRELI = ETL86C0R3913[ 1 ]-KRELI.
  MOVE-CORRESPONDING LML86C0R8461 TO KONV.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
* End of Quick Fix
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL300C0R1213) ).
  KONV = ETL300C0R1213[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
 ...
 ( fieldname = 'KPOSN' value = 3 )
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL313C0R92) ).
  KONV = ETL313C0R92[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL326C0R8614) ).
  LS_KONV = ETL326C0R8614[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL352C0R328) ).
  TYPES: BEGIN OF TYL352C0R4010,
    KSCHL TYPE KONV-KSCHL,
    KRECH TYPE KONV-KRECH,
  END OF TYL352C0R4010.
  DATA LML352C0R9485 TYPE TYL352C0R4010.
  LML352C0R9485-KSCHL = ETL352C0R328[ 1 ]-KSCHL.
  LML352C0R9485-KRECH = ETL352C0R328[ 1 ]-KRECH.
  LS_KONV = LML352C0R9485.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL482C0R5340) ).
  LS_KONV = ETL482C0R5340[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL495C0R5198) ).
  LS_KONV_CUST = ETL495C0R5198[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL508C0R6807) ).
  LS_KONV = ETL508C0R6807[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL521C0R2133) ).
  TYPES: BEGIN OF TYL521C0R398,
    KRECH TYPE KONV-KRECH,
  END OF TYL521C0R398.
  DATA LML521C0R6196 TYPE TYL521C0R398.
  LML521C0R6196-KRECH = ETL521C0R2133[ 1 ]-KRECH.
  MOVE-CORRESPONDING LML521C0R6196 TO LS_KONV.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL534C0R2695) ).
  TYPES: BEGIN OF TYL534C0R5205,
    KRECH TYPE KONV-KRECH,
  END OF TYL534C0R5205.
  DATA LML534C0R3783 TYPE TYL534C0R5205.
  LML534C0R3783-KRECH = ETL534C0R2695[ 1 ]-KRECH.
  MOVE-CORRESPONDING LML534C0R3783 TO LS_KONV_CUST.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL547C0R3506) ).
  LS_KONV = ETL547C0R3506[ 1 ].
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL560C0R5389) ).
  MOVE-CORRESPONDING ETL560C0R5389[ 1 ] TO LS_KONV_CUST.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL573C0R4317) ).
  LS_KONV-KRECH = ETL573C0R4317[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
...
CL_PRC_RESULT_FACTORY=>GET_INSTANCE( )->GET_PRC_RESULT( )->GET_PRICE_ELEMENT_DB(
  ...
  IMPORTING ET_PRC_ELEMENT_CLASSIC_FORMAT = DATA(ETL586C0R9069) ).
  LV_KONV_KRECH = ETL586C0R9069[ 1 ]-KRECH.
CATCH CX_PRC_RESULT CX_SY_ITAB_LINE_NOT_FOUND .
  SY-SUBRC = 4.
ENDTRY.
