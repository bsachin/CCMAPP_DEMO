*&---------------------------------------------------------------------*
*& Report z_s4h_bseg_data_check_11
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT z_ccm_bseg_data_check_11.
...
DATA RLDNR_L27C0R8427 TYPE RLDNR.
CALL FUNCTION 'FAGL_GET_LEADING_LEDGER'
  IMPORTING E_RLDNR = RLDNR_L27C0R8427
  EXCEPTIONS NOT_FOUND     = 1
             MORE_THAN_ONE = 2.
IF SY-SUBRC = 0.
CALL FUNCTION 'FAGL_GET_GL_DOCUMENT'
  EXPORTING
    I_RLDNR = RLDNR_L27C0R8427
    I_BUKRS = '1234'
    I_BELNR = '1234567890'
    I_GJAHR = 2019
  IMPORTING
